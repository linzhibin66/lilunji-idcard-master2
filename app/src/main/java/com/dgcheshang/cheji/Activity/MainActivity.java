...
import com.dgcheshang.cheji.netty.timer.AdminCardTask;
...
//            showOutDialog();
    ...
    protected void onResume() {
        ...
        AdminCardTask cardTask=new AdminCardTask(mRFID,"admincard");
        NettyConf.cardtimer=new Timer();
        NettyConf.cardtimer.schedule(cardTask,300,2000);
    }
